...
class ConversationalTrafficAgent:
    ...
    def _init_chains(self):
        ...
        generator_system_prompt = (
            ...
            "1. **Mức xử phạt tổng hợp**: Ghi rõ tổng số tiền phạt (hoặc khoảng phạt), tổng số điểm GPLX bị trừ, tổng thời gian tước bằng (nếu có).\n"
            ...
            "   - Số tiền phạt áp dụng (ghi dạng khoảng phạt, giải thích ngắn gọn nếu áp dụng mức phạt tối đa do tình tiết tăng nặng như bỏ chạy/gây tai nạn).\n"
